...
define gui.about = _p("""Данная игра с любовью создана пользователем #Momo и посвящается всем людям, принимавшим участие в ролевой на нашем Discord сервере.
Игра распространяется бесплатно, разрешение создателя не требуется. Все права на использованные материалы принадлежат их создателям.
""")
...
define build.name = "RProject"
define build.directory_name = "RProject"
...
define config.save_directory = "RolkaProject-1539892117"
